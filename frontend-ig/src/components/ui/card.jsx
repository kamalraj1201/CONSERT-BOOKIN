...
const Card = React.forwardRef(({ className, variant = 'default', ...props }, ref) => {
    ...
    return (<div ref={ref} className={cn("rounded-xl border shadow-card transition-all duration-300 hover:shadow-neon", variants[variant], className)} {...props}/>);
});
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (<h3 ref={ref} className={cn("font-display text-xl font-bold leading-none tracking-tight", className)} {...props}/>));
